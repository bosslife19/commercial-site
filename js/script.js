...
function init(){
    var button = document.getElementById("boo");
     button.onclick = function(e){
        ...
        //  
         alert("NO DEY CLICK ME BOSS, YOU NO FIT AFFORD AM!!")
          ...
          if(good < 40000){
              alert("broke fool leave this page osiso!!");
     ...
     var a = document.getElementById("chair");
          a.ondblclick = function(){
              let number = prompt("put in your number here");
              if (number==09066487638){
                  alert("study headfirst javascript today")
              }
              else if(number==undefined){
                  alert("put in a number")
              }else{
                  alert("wrong number try again after you don hustle")
              }
